        ...
        <div class="my_auth_form_box">
            ...
            <div>
                ...
                <div style="display: flex">
                    ...
                    <input id="username" class="my_auth_form_box_input" placeholder="${user.username}" maxlength="20"
                        required readonly />
                </div>
                <div style="display: flex">
                    <div class="my_auth_form_box_info_detail">이메일</div>
                    <input name="email" class="my_auth_form_box_input" type="email" value="${user.email}" maxlength="60"
                        required />
                </div>

                <div style="text-align: right">
                    <a href="/user/emailCheckForm"><button type="submit" class="btn btn-outline-primary">
                            이메일 변경
                        </button></a>
                </div>
            </div>
            ...
            <div>
                <div>
                    <i class="fa-solid fa-triangle-exclamation fa-lg" style="color: red">
                        위험</i>
                </div>
