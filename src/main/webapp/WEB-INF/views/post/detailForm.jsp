...
<div class="container">
    ...
    <div style="display: flex;">
        ...
        <div style="display: inline-flex;">
            <c:if test="${principal.userId==post.userId}">
                <a class="btn btn-outline-warning" href="/s/api/post/updateForm/${post.categoryId}/${post.postId}"
    ...
    <div class="my_post_info_box d-flex" style="margin-top: 50px;">
        ...
        <div class="d-flex justify-content-between">
            <div>
                공감 <i id="iconLove" class='${post.loved ? "fa-solid" : "fa-regular"} fa-heart my_pointer my_red'></i>
