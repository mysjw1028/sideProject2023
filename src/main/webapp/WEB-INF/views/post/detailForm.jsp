...
<div class="container">
    <form action="/update/${postId}/delete" method="post">
        ...
        <div class="my_post_info_box d-flex" style="margin-top: 50px;">
            ...
            <input id="userId" type="hidden" value="${PostDetail.userId}" /><!--제이쿼리로 쓸려고 -> 심어놓고 댕기기-->
            <input id="lovesId" type="hidden" value="${PostDetail.lovesId}" />
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        좋아요<span id="countLove">${PostDetail.loveCount}</span> <i id="iconLove"
                            class='${PostDetail.loveId ? "fa-solid" : "fa-regular"} fa-heart my_pointer my_red'></i>
                    </div>
                </div>
