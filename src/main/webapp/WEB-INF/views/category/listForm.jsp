    ...
    <c:if test="${principal.userId==category.userId}">
        <span class="btn_form">
            <a href="/category/updateForm/${category.categoryId}">
                <span class="btn_form_update"><button id="btnUpdate"
                        class="btn btn-outline-warning">수정</button></a></span>
            ...
            <div class="d-flex justify-content-end">
                <div>
                    <form style="display: inline-flex" method="get"
                        action="/category/listForm/${category.categoryId}/${category.userId}">
                ...
                <div class="my_post_list_item_right my_ellipsis">
                    ...
                    <div class="my_mt_md_1">
                        <a href="/post/detailForm/${post.postId}/${post.userId}"><button type="button"
                                class="btn btn-light" style="border:2px solid black">더보기</button></a>
                    </div>
                </div>
            </div>
        </c:forEach>
